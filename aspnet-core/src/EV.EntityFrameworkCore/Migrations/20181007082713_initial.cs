        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlAddress = table.Column<string>(maxLength: 500, nullable: false),
                    IsExpand = table.Column<bool>(nullable: false),
                    IsPublic = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ev_menu", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ev_menubutton", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ev_menubutton_ev_menu_MenuId",
                        column: x => x.MenuId,
                        principalTable: "ev_menu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
